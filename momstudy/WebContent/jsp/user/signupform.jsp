        ...
        <form action="<c:url value="/user/signup.do"/>" method="post">
            <div class="fieldset">
                ...
                <div class="select_wrap">
                    ...
                    <select id="birth_date" name="date">
                        <option value="1" selected>1</option>
                ...
                <div class="category_wrap">
                    <ul>
                    <c:forEach items="${cateList}" var="category" varStatus="loop">
                        <li>
                            <input id="it" type="checkbox" name="category" value="${loop.index }" />
                            <label for="it">${cateList}</label>
                        </li>
                    </c:forEach>                
                    </ul>
                </div>
