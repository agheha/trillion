...
@WebServlet("/study/adminaprovalmember.do")
public class StudyAdminAprovalMemberController extends HttpServlet{
	UserDAO dao;
	
	public StudyAdminAprovalMemberController() {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<User> ulist = dao.selectUserByStudyNum2(search);
		...
		req.getRequestDispatcher("/jsp/study/adminstudyaproval.jsp").forward(req, resp);
