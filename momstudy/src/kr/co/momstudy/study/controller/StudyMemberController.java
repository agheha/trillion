...
@WebServlet("/study/member.do")
public class StudyMemberController extends HttpServlet{
	UserDAO dao;
	
	public StudyMemberController() {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/jsp/study/studymembers.jsp").forward(req, resp);
